    ...
    \subsection{Experimentación}
        ...
        \subsubsection{Modelo con Data Augmentation}
            ...
            \begin{itemize}
                ...
                \item Tras esto, se entrenará el modelo con el dataset al cual se le aplicarán técnicas de data augmentation, para aumentar el número de datos de entrenamiento e incrementar aún más la variabilidad de los mismos, de manera que cada imagen del dataset sufrirá de manera aleatoria una traslación ($\pm 4\%$), un reescalado ($\pm 5\%$) y una rotación ($\pm 30$ grados). El entrenamiento en este nuevo dataset será durante \textbf{40 épocas} tras acabar las de la etapa anterior. 
