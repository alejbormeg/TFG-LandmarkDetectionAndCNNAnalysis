...
\noindent  Además de la convergencia punto a punto cabe destacar que, mientras que hasta ahora se ha trabajado exclusivamente en $L^2(\mathbb{R}^d)$, el operador presentado se encuentra en $L^1(\mathbb{R}^d)$. Sin embargo, en la sección $3.2$ de \cite{GroupInvariantScattering}, se demuestra que el operador $\overline{S}f(p), \; \forall f \in L^2(\mathbb{R}^d)$ y para todo camino $p$, pertenece a $L^2(\mathbb{R}^d)$. Además se da una condición suficiente que garantiza la convergencia uniforme de del operador de ventana $S_Jf$ en $\overline{S}f$. Sin embargo no se consigue dar una demostracion para el recíproco, a pesar de que puede apreciarse en numerosos ejemplos. Debido a la falta de tiempo y la gran complejidad técnica de la sección referenciada anteriormente, se ha optado por citarla para justificar así el motivo por el que se define en $L^1(\mathbb{R}^d)$.
