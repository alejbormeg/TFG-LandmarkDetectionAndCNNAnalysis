...
\noindent Actualmente, las \textbf{Redes Neuronales Convolucionales} (CNN \footnote{Convolutional Neural Network}) están consideradas como unas de las mejores herramientas de la Inteligencia Artificial para tareas de Aprendizaje Automático (AA), de hecho son el principal objeto de estudio del conocido \textbf{Deep Learning}, una subrrama del AA en la que hoy en día se están invirtiendo mucho esfuerzo en invesitgar y de la que anualmente se publican muchos artículos que nos enseñan la gran potencia de las CNN.


\medskip

\noindent Destaca especialmente el increible desempeño que tienen las CNN en el procesamiento de imágenes en tareas de clasificación, segmentación o incluso generación de nuevas imágenes. Es por ello que en el presente trabajo nos proponemos realizar una modelización matemática de estas CNN, para conocerlas mejor desde este punto de vista más técnico y ser capaces de demostrar una de sus principales propiedades: La invarianza por traslaciones.
