...
\noindent Vamos a ver un contraejemplo con una función de $\mathbb{R} \rightarrow \mathbb{R}$.
...
\begin{align*}
  ...
  &=\left(\int_{\mathbb{R}} \left| \frac{1}{1+\left[ \frac{(1-\epsilon) \xi - \omega}{(1-\epsilon)}\right]^2}-\frac{1}{1+(\xi - \omega)^2} \right|^2 d\omega\right)^{\frac{1}{2} }
\end{align*}
...
el escalado por medio de $\tau$ produce que la frecuencia $\xi$ se traslade de $\xi$ a $(1-\epsilon)\xi$, si suponemos que $\Theta$ además es regular con decrecimiento rápido, se tiene que:
