...
\noindent Con esta defnición presentamos el siguiente teorema:
...
\begin{proof}
  Esta demostración tiene dos partes, la primera consistirá en demostrar que la condición (2.27) implica que $\lim_{m\rightarrow \infty} ||U[\Lambda_J^m]f||^2=0$. 

  \medskip

  \noindent En segundo lugar vamos a ver que las siguientes expresiones son equivalentes: 
  \begin{align*}
