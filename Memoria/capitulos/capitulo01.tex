...
\noindent A modo de ejemplo, vamos a ver la base de Haar que se construye a partir de la siguiente función: 
...
\noindent Con esta, podemos generar la siguiente base ortonormal:
