...
\section{Aprendizaje Automático}
    ...
    \noindent La primera y más clásica nos la proporciona Arthur Samuel en $1959$, en la cual define el AA como \textbf{el área de conocimiento que da a los ordenadores la capacidad de aprender sin ser programados explícitamente}. Esta definición es poco precisa, pero nos permite hacernos una idea de lo que se pretende conseguir, que es dotar a los ordenadores de la capacidad de \entrecomillado{aprender} a resolver un determinad problema a partir de una base de datos de entrenamiento.
