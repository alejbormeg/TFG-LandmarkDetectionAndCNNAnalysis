...
\begin{frame}{Problema: La escala}
  \begin{figure}
    ...
    \caption{Imagen extraída de \cite{WAVELETS}.}
  \end{figure}
...
\begin{frame}{Adversarial Autoencoder (AAE)}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{imgs/AAE_1.png}
...
\begin{frame}{Adversarial Autoencoder (AAE)}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{imgs/AAE_2.png}
    \caption{Imagen extraída de \cite{AAE}.}
  \end{figure}
\end{frame}
...
\begin{frame}{Adversarial Autoencoder (AAE)}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{imgs/AAE_3.png}
    \caption{Imagen extraída de \cite{AAE}.}
  \end{figure}
\end{frame}
...
\begin{frame}[t]{Estado del arte}
  \begin{itemize}
    \item TFG Realizado por Guillermo Gómez \cite{guillermo2019}.
    \item Expuesto en Conferencia Forense en 2019.
    \item Modelo basado en \textbf{HyperFace-ResNet}.
    \item \textbf{Predicción} y \textbf{clasificación} de landmarks cefalométricos.
    \item \textbf{Misma base de datos} + 99 modelos $3D$.
    \item Se disponía del \textbf{código} y los \textbf{resultados}.
  \end{itemize}
...
\begin{frame}[t]{3FabRec}
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/3FabRec_1.png}
    \caption{Imagen extraída de \cite{browatzki20203fabrec}.}
  \end{figure}
\end{frame}
...
\begin{frame}[t]{3FabRec}
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/3FabRec_2.png}
    \caption{Imagen extraída de \cite{browatzki20203fabrec}.}
  \end{figure}
\end{frame}
...
\begin{frame}[t]{3FabRec}
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/3FabRec_3.png}
    \caption{Imagen extraída de \cite{browatzki20203fabrec}.}
  \end{figure}
\end{frame}
...
\begin{frame}[t]{3FabRec}
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/3FabRec_4.png}
    \caption{Imagen extraída de \cite{browatzki20203fabrec}.}
  \end{figure}
\end{frame}
...
\begin{frame}[t]{3FabRec}
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/3FabRec_5.png}
    \caption{Imagen extraída de \cite{browatzki20203fabrec}.}
  \end{figure}
\end{frame}
...
\begin{frame}[t]{Preprocesamiento}
  \begin{columns}[onlytextwidth]
    \begin{column}{.65\textwidth}
      \begin{itemize}
        \item \small Realizamos \textbf{detección + \textit{cropping}} de caras en las imágenes del dataset.
        \item \small Empleamos red auxiliar \textbf{Facenet}\cite{DBLP:journals/corr/SchroffKP15}.
        \item \small\textbf{Problema}: Algunos landmarks quedan fuera del \textit{bounding box}. Se necesita un \textbf{reajuste}.
      \end{itemize}
      % square filling the column
      % place an image
      % horizontal position = 73%
...
\begin{frame}{Comparativa HF-Resnet \cite{guillermo2019}}

  \begin{columns}[onlytextwidth]
    \begin{column}{.4\textwidth}
      \normalsize \textbf{Diferencias:}
      \begin{itemize}
        \item \scriptsize \textbf{Métrica: }
            \begin{equation*}
